...
bool comparer(const std::shared_ptr<FileSystemObject> a, const std::shared_ptr<FileSystemObject> b) {
    return a->getName()<b->getName();
}


std::string getTreeView(std::vector<std::shared_ptr<FileSystemObject> >::const_iterator begin, std::vector<std::shared_ptr<FileSystemObject> >::const_iterator end, const std::string & indentation) {
