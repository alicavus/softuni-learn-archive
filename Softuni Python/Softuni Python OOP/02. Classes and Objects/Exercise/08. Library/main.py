...
user_one = User(12, 'Peter')
user_two = User(9, 'Andrei')
library = Library()
registration = Registration()
print(registration.add_user(user_one, library))
print(registration.add_user(user_one, library))
print(registration.add_user(user_two, library))
library.books_available.update({'J.K.Rowling': ['The Chamber of Secrets',
                                                ...
                                                'The Deathly Hallows']})
library.get_book('J.K.Rowling', 'The Deathly Hallows', 10, user_two)
library.get_book('J.K.Rowling', 'The Half-Blood Prince', 10, user_one)
library.get_book('J.K.Rowling', 'The Half-Blood Prince', 10, user_two)
print(user_two)
